            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit-ghế</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Edit-ghế</li>
                        </ol>
                        <div class="container-fluid">
                   
                            <form  method="POST" action="{{route('ghe.update',['id'=>$ghes->id])}}">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label">Tên ghế</label>
                                    <input type="text" class="form-control" name="tenghe" value="{{ $ghes->tenghe }}" placeholder="Nhập tên ghế" required>
                                  </div>
                                ...
                                @endif
                                  <div class="mb-3">
                                      ...
                                      <input type="text" class="form-control" name="trangthai" value="{{ $ghes->trangthai}}" placeholder="Nhập trạng thái ghế" required>
                                    </div>
                                    <div class="mb-3">
                                      <label for="ghe_phongchieu" class="form-label">Chọn phòng chiếu</label>
                                      <select class="form-select" id="ghe_phongchieu" name="ghe_phongchieu" required>
                                        <option value="0" disabled selected>Chọn phòng chiếu</option>
                                        @foreach($phongchieus as $item)
                                        
                                        @if ($item->id==$ghes->id_phongchieu)
