                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="container-fluid">
                            ...
                            <form  method="POST" action="{{route('feedback.update',['id'=>$user_feedback->id])}}">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label">email khách hàng</label>
                                    <input type="email" class="form-control" name="email" value="{{ $user_feedback->email }}" placeholder="Nhập email" required>
                                  </div>
                                  <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="noidung" rows="3" placeholder="Nhập nội dung phản hồi" ></textarea>
                                      </div>    
