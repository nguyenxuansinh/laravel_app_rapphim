                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <a href="{{ route('admin.create_ghe') }}" class="btn btn-primary mb-3">add</a>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('ghe.edit',['id' => $item->id])}}" class="btn btn-success">edit</a></td>
                                            <td>
                                                <form action="{{route('ghe.delete',['id' => $item->id])}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
