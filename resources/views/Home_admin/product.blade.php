                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><div style="height: 75px; overflow-y: auto;">{{$item->dienvienchinh}}</div></td>
                                            <td>{{$item->ngayphathanh}}</td>
                                            <td>{{$item->thoiluong}}</td>
                                            <td ><div style="height: 75px; overflow-y: auto;">{{$item->mota}}</div></td>
                                            <td><img height="75" src="{{asset('image_phims/'.$item->hinhanh)}}"></td>
                                            <td>
