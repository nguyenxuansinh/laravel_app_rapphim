                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <a href="{{ route('admin.create_suatchieu') }}" class="btn btn-primary mb-3">add</a>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$item->giave}}</td>
                                            <td><a href="{{route('suatchieu.edit',['id' => $item->id])}}" class="btn btn-success">edit</a></td>
                                            <td>
                                                <form action="{{route('suatchieu.delete',['id' => $item->id])}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
