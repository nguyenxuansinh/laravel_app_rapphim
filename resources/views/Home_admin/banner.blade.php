                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <a href="{{ route('admin.create_banner') }}" class="btn btn-primary mb-3">add</a>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img height="75" src="{{asset('image_banner/'.$item->anh_banner)}}"></td>
                                            
                                            <td><a href="{{route('banner.edit',['id' => $item->id])}}" class="btn btn-success">edit</a></td>
                                            <td>
                                                <form action="{{route('banner.delete',['id' => $item->id])}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
