            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Add-Suất chiếu</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Add-Suất chiếu</li>
                        </ol>
                        <div class="container-fluid">
                   
                            <form  method="POST" action="{{ route("suatchieu.insert_suatchieu") }}" enctype="multipart/form-data">
                                @csrf
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" name="thoigianchieu" placeholder="Nhập thời gian chiếu" required>
                                  </div>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" name="thoigianketthuc" placeholder="Nhập thời gian kết thúc" required>
                                  </div>

                                  <div class="mb-3">
                                    <label class="form-label">Giá vé</label>
                                    <input type="number" class="form-control" name="giave" placeholder="Nhập giá vé" required>
                                  </div>
