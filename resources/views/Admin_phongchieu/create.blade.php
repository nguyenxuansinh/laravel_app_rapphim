            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Add-Phòng chiếu</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Add-Phòng chiếu</li>
                        </ol>
                        <div class="container-fluid">
                   
                            <form  method="POST" action="{{ route("admin.insert_phongchieu") }}" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
